...
app.get('/api/insights/completions', authenticate, requirePermission('dimensions.view.all'), (req, res) => {
  const month = normalizeMonthInput(req.query.month);
  const start = normalizeMonthInput(req.query.start);
  const end = normalizeMonthInput(req.query.end);
...
app.get('/api/insights/person-dimensions', authenticate, requirePermission('dimensions.view.all'), (req, res) => {
