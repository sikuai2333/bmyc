...
export function TopBar({
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-30 h-16 bg-white border-b border-slate-200 ${sidebarOffset}`}
    >
      <div className="flex h-full items-center justify-between px-4 lg:px-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-base font-semibold text-slate-800">金岩高新百名英才档案管理</h1>
            <p className="text-xs text-slate-500">融合多维档案，洞察人才脉动</p>
          </div>
        </div>
        <div className="flex items-center gap-3">
          <button
